...
public class Dummy
{
	...
	public final NienKhoaNganh nienKhoaNganh												= new NienKhoaNganh(1, nienKhoa, nganh);
	public final NienKhoaNganhNamHocKyHoc nienKhoaNganhNamHocKyHoc							= new NienKhoaNganhNamHocKyHoc(1, nienKhoaNganh, namHocKyHoc);
	public final NienKhoaNganhNamHocKyHocMonHoc nienKhoaNganhNamHocKyHocMonHoc				= new NienKhoaNganhNamHocKyHocMonHoc(1, nienKhoaNganhNamHocKyHoc, monHoc);
	...
	public final KetQua ketQua																= new KetQua(1, 9.0, 9.0, 9.0, 9.0, 9.0, 0.0, 0.0, "", sinhVien, null);
