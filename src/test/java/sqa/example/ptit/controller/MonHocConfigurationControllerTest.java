...
public class MonHocConfigurationControllerTest {
	...
	public void getAllMonHocByNganh() throws Exception {
		...
		var dummyNienKhoaNganh = new NienKhoaNganh(1, dummyNienKhoa, dummyNganh);
		var dummyNamHocKyHoc = new NamHocKyHoc(1, dummyNamHoc, dummyKyHoc);
		var dummyNienKhoaNganhNamHocKyHoc = new NienKhoaNganhNamHocKyHoc(1, dummyNienKhoaNganh, dummyNamHocKyHoc);
		var dummyNienKhoaNganhNamHocKyHocMonHoc = new NienKhoaNganhNamHocKyHocMonHoc(1, dummyNienKhoaNganhNamHocKyHoc, dummyMonHcc);
		...
		when(nienKhoaNganhNamHocKyHocMonHocService.findAllByNienKhoaNganhNamHocKyHocId(dummyNienKhoaNganhNamHocKyHoc.getId())).thenReturn(Arrays.asList(dummyNienKhoaNganhNamHocKyHocMonHoc));
