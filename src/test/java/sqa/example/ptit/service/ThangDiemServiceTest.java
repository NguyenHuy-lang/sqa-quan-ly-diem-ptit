...
import sqa.example.service.ThangDiemServiceUtils;
...
public class ThangDiemServiceTest 
{
	...
	public void utils_isInvalidF() {
		var dummy = new ThangDiem(1, 0.0, 2.0, "", 0.0);
		var expectedResult = false;
		
		assertEquals(ThangDiemServiceUtils.isInvalid(dummy), expectedResult);
	}
	
	@Test
	public void utils_isInvalidT() {
		var dummy = new ThangDiem(1, 203.0, 2.0, "", 0.0);
