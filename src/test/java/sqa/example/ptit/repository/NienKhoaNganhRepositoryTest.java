...
public class NienKhoaNganhRepositoryTest {
	...
	public void findByNienKhoaAndNganhId() {
		...
		var expectedResult = new NienKhoaNganh(1, expectedNienKhoa, expectedNganh);
		
		var result = repository.findByNienKhoaAndNganhId(expectedNienKhoa.getId(), expectedNganh.getId());
