...
public class NienKhoaNganhNamHocKyHocRepositoryTest {
    ...
    public void findByNienKhoaNganhAndNamHocKyHocId() {
        ...
        var expectedResult = new NienKhoaNganhNamHocKyHoc(1, expectedNamHocKyHoc, expectedNienKhoaNganh);

        var result = repository.getNienKhoaNganhNamHocKyHoc(expectedNienKhoaNganh.getId(), expectedNamHocKyHoc.getId());
    ...
    public void findAllByNamHocKyHocId() {
        var result = repository.getListNienKhoaNganhNamHocKyHoc(1);
        assertEquals(result.isEmpty(), false);
    }
}